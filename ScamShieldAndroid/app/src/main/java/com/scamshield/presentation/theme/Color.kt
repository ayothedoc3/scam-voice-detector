package com.scamshield.presentation.theme
...
// Risk Level Colors
val risk_low = Color(0xFF4CAF50)
val risk_medium = Color(0xFFFFC107)
val risk_high = Color(0xFFFF9800)
val risk_critical = Color(0xFFF44336)
