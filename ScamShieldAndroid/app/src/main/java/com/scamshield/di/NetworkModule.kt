...
import com.scamshield.data.remote.api.AnalysisApi
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideProtectionApi(retrofit: Retrofit): ProtectionApi {
        return retrofit.create(ProtectionApi::class.java)
    }
